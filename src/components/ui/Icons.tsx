...
export const ICONS = {
  ...
  clock:  <Ico d={<g><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3.5 2" /></g>} />,
  eye:    <Ico d={<g><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z" /><circle cx="12" cy="12" r="3" /></g>} />,
